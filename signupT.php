		...
		<form class="form-horizontal" method="post">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="name" name="name" type="text" placeholder="*required" class="form-control input-md" required="">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="user_name" name="user_name" type="text" placeholder="*required" class="form-control input-md" required="">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="pwd" name="pwd" type="password" placeholder="*required" class="form-control input-md" required="">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="bio" name="bio" type="text" placeholder="" class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="phone_number" name="phone_number" type="number" placeholder="" class="form-control input-md">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="zip" name="zip" type="number" placeholder="*required" class="form-control input-md" required="">
