		...
		<form class="form-horizontal" method="post">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="p_name" name="p_name" type="text" placeholder="*required" class="form-control input-md" required="">
				...
				<!-- Textarea -->
				<div class="form-group">
					<label class="col-md-4 control-label" for="p_desc">Description</label>
					<div class="col-md-4">                     
						<textarea class="form-control" id="p_desc" name="p_desc"></textarea>
					</div>
				</div>
